document.addEventListener('DOMContentLoaded', () => {
    ...
    const heroLongestStreak = document.getElementById('hero-longest-streak'); // New variable
    ...
    // New counter for Longest Streak
    if (heroLongestStreak) {
        let count = 0;
        const targetCount = 30; // Example: 30 days
        const interval = setInterval(() => {
            ...
            options: {
                ...
                scales: {
                    x: {
                        ...
                        ticks: {
                            color: '#a0a0a0' // Text color for labels
                        }
                    },
                    y: {
                        beginAtZero: true,
                ...
                animation: { // Animation on initial load
